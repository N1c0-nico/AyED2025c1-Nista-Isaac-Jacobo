...
import unittest
from modules.arbol import Arbol
import numpy as np
...
class Testabb(unittest.TestCase):
    ...
    #     un elemento está o no en el Arbol
    #     """
...
#         self.assertEqual(self.arbol.tamano, 0, "Al instanciar el Arbol, su tamaño debe ser cero")
#         for n, i in enumerate(claves):
#             self.arbol.agregar(clave=i, valor=2*i)
#             self.assertEqual(self.arbol.tamano, n+1, f"Arbol deberia tener {n+1} elementos")
...
#             self.assertEqual(self.arbol.tamano, size-1-n, f"Arbol deberia tener {size-1-n} elementos")
#         # (re)agregado
#         np.random.shuffle(claves)
#         for n, i in enumerate(claves):
#             self.arbol.agregar(clave=i, valor=2*i)
...
#         """
#         Verifica que el Arbol tenga sobrecargado los métodos necesarios
