...
class Test_LDE(unittest.TestCase):
    """Test de la clase ClaseNodoYLDE.ListaDobleEnlazada"""

    def setUp(self):
        self.n_elementos = 200
        """ LDE vacía """
        self.lde_1 = ClaseNodoYLDE.ListaDobleEnlazada()

        """ LDE con elementos repetidos con lista auxiliar"""
        self.lde_2 = ClaseNodoYLDE.ListaDobleEnlazada()
        ...
        self.lde_3 = ClaseNodoYLDE.ListaDobleEnlazada()
    ...
    def test_agregar_al_inicio(self):
        ...
        nodo_original = self.lde_2.primero
        ...
        self.assertEqual(lde1_copia.primero.dato, valorNuevo,
                        "El nodo agregado a la lista vacia no contiene el valor que se solicito agregar")
        self.assertIs(lde1_copia.primero, lde1_copia.ultimo,
                    "En una lista de un elemento, la primero es la misma que la cola")
    ...
    def test_agregar_al_final(self):
        ...
        self.assertIs(nodo_copia, lde2_copia.ultimo,
                    "El ultimo nodo no coincide con la refencia a la ultimode la lista")
    ...
    def test_extraer_interior(self):
        ...
        nodo_original = self.lde_3.primero
        nodo_copia = lde3_copia.primero
        contador_pos = 0
    ...
    def test_copiar(self):
        ...
        nodo_original = self.lde_3.primero
        nodo_copia = lde_3_copia.primero
    ...
    def test_invertir(self):
        ...
        nodo_invertido = lista_copia.primero
        nodo_original = self.lde_1.ultimo
    ...
    def recorrer_lista(self, lista):
        ...
        self.assertIsNone(nodo.anterior,
                        "El elemento anterior a la primero de la lista debe ser None")
        ...
        self.assertIsNone(nodo.siguiente,
                        "El elemento siguiente a la ultimode la lista debe ser None")
    ...
    def test_metodo_concatenar(self):
        ...
        nodo_original = self.lde_3.primero
        nodo_concat = lista_concatenada1.primero
        while nodo_original is not None:
