...
from modules import ListaDE
import unittest
import random


class Test_LDE(unittest.TestCase):
    """Test de la clase ListaDE.ListaDobleEnlazada"""

    def setUp(self):
        self.n_elementos = 200
        """ LDE vacía """
        self.lde_1 = ListaDE.ListaDobleEnlazada()

        """ LDE con elementos repetidos con lista auxiliar"""
        self.lde_2 = ListaDE.ListaDobleEnlazada()
        ...
        self.lde_3 = ListaDE.ListaDobleEnlazada()
